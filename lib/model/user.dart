...
class Usuario {
  ...
  // Retorna ImageProvider da foto (Web: MemoryImage, Mobile: FileImage)
  ...
  Future<void> cadastrarUsuario({
    ...
    try {
      ...
      if (e.code == 'email-already-in-use') mensagem = "Email já está em uso";
      if (e.code == 'weak-password') mensagem = "Senha muito fraca";
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> loginUsuario({
    ...
    try {
      ...
      if (e.code == 'invalid-email') mensagem = "Email inválido";
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(mensagem)),
      );
    } catch (e) {
